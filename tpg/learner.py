...
class Learner:
    ...
    """
    def bid(self, state, rootMem):
        self.program.execute(state, rootMem, self.registers,
    ...
    """
    def getAction(self, state, rootMem, visited):
        if self.isActionAtomic():
            return self.action
        else:
            return self.action.act(state, rootMem, visited)
